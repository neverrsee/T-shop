...
from core.views import form_view
from core.views import magic_number
from core.views import old_project
...
urlpatterns = [
    ...
    path('form/', form_view),
    path('magic/', magic_number),
    path('oldpro/', old_project, name='old_proj'),
    ...
    path('blog/post_likes/', post_like, name='post_like'),
